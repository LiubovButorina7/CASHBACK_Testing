...
### - Задание: 
  написать чек-лист проведения тестирования кэшбэка.
...
6.	Если клиент отказался от кэшбэка (отключил акцию без выплаты кэшбэка на счет):
  - Весь накопленный, невыплаченный и неучтенный кэшбэк "сгорает". В справочнике "Кэшбэк по картам" проставляется "Признак исключения из кэшбэка" = Да. 
...
## Чек-лист тестирования кэшбэка: 

- https://docs.google.com/spreadsheets/d/1pDCkcFpkoqBJpJJVoy3jVNv4A3VoajUeWfCjE374duQ/edit?usp=sharing
